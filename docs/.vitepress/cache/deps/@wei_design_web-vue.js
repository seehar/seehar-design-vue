...
function a(...t) {
    ...
    for (let o = 0; o < t.length; o++) {
        ...
        if (!!e) {
            ...
            else if (y(e)) for (const s in e) e[s] && n.push(s)
        }
    }
    return n.join(' ')
}
...
var _ = defineComponent({
    ...
    setup(t) {
        return {
            classString: a(['we-button', `we-button-type-${t.type}`, t.disabled ? 'we-button-disabled' : ''])
        }
    }
})
var h = (t, n) => {
    const o = t.__vccOpts || t
    for (const [e, s] of n) o[e] = s
    return o
}
var S = ['disabled']
...
function B(t, n, o, e, s, l) {
    return (
        ...
        createElementBlock(
            ...
            [createBaseVNode('span', $, [renderSlot(t.$slots, 'default')])],
            10,
            S
        )
    )
...
export { i as Button, A as default }
